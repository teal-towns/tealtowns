...
def test_shared_item_get_payments():
    ...
    assert(payments['downPerPersonWithFee'] == 105)
    ...
    assert(payments['downPerPersonWithFee'] == 1560)
    assert(payments['monthlyPayment'] == 196)
    assert(payments['monthlyPaymentWithFee'] == 205)
    ...
    assert(payments['downPerPersonWithFee'] == 2232)
    assert(payments['monthlyPayment'] == 130)
    assert(payments['monthlyPaymentWithFee'] == 137)
    ...
    assert(payments['downPerPersonWithFee'] == 3901)
    assert(payments['monthlyPayment'] == 1271)
    assert(payments['monthlyPaymentWithFee'] == 1323)
    ...
    assert(payments['downPerPersonWithFee'] == 59)
...
def test_add_remove_fee():
    ...
    assert(_shared_item_payment_math.AddFee(100, withCut = False) == 104)
    assert(_shared_item_payment_math.AddFee(100) == 105)
    assert(_shared_item_payment_math.RemoveFee(105) == 100)
    assert(_shared_item_payment_math.RemoveFee(105, withPayFee = False) == 104)
    assert(_shared_item_payment_math.RemoveFee(105, withCut = False) == 101)
    assert(_shared_item_payment_math.AddFee(1000) == 1040)
