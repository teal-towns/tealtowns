...
def GetByUName(uName: str, withWeeklyEvents: int = 0, withSharedItems: int = 0, withSustainability: int = 0,
    ...
    limitCount: int = 250, withUsersCount: int = 0, withEventUsersCount: int = 0, userId: str = ''):
    ...
    if withWeeklyEvents or withEventUsersCount:
