...
void main() {
  ...
  test('SharedItemService.GetPayments', () {
    ...
    expect(payments['monthlyPaymentWithFee'], 2644);
    expect(payments['monthsToPayBack'], 5*12);
