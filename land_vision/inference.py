...
import os
import yaml
from land_vision.evaluate import predict, make_figure_with_pred
import land_vision.models.SFANet as SFANet
...
def main():
    ...
    with open(os.path.join(args.log,'predicted_loc_results.txt'),'w') as f:
    ...
    #plt.show()
    fig.savefig(os.path.join(args.log,'pred_figures.pdf'))
